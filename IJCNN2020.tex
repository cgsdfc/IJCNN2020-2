...
\cite{TowardsAMetric} adopts the thought of trained metrics underneath ADEM and trains an AutoJudge metric on dialogues generated by `self-talk' of a dialogue system.
